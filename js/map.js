...
<div style="display: flex; gap: 0.4rem;">
    ...
    ${shop.xarxes_socials ? `<button class="popup-btn popup-btn-secondary" onclick="window.open('${shop.xarxes_socials.startsWith('http') ? shop.xarxes_socials : 'https://' + shop.xarxes_socials}', '_blank')" style="flex: 1; padding: 0.8rem 0.2rem;"><i class="fab fa-instagram"></i></button>` : `<button class="popup-btn popup-btn-secondary" disabled style="flex: 1; padding: 0.8rem 0.2rem; opacity: 0.3; cursor: not-allowed;"><i class="fas fa-share-alt"></i></button>`}
