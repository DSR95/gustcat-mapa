...
<div class="commerce-actions-row">
    ...
    ${shop.xarxes_socials ? `<button class="action-btn" onclick="event.stopPropagation(); window.open('${shop.xarxes_socials.startsWith('http') ? shop.xarxes_socials : 'https://' + shop.xarxes_socials}', '_blank')"><i class="fas fa-instagram"></i></button>` : ''}
